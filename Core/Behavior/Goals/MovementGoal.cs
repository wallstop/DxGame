    ...
    */
    ...
    public class MovementGoal : AbstractGoal
    {
            ...
            : base(goalChaser, timeout, reference)
        {
            ...
            Validate.IsNotNull(positionalComponent,
                StringUtils.GetFormattedNullOrDefaultMessage(this, positionalComponent));
            Target = target;
        }
        ...
        public override bool IsComplete(Frame reference)
        {
            ...
            var currentPosition = reference.ObjectMapping[goalChaser_.Id].ComponentOfType<PositionalComponent>().Position;

...
namespace DXGameTest.Core.Property
{
    public class PropertyMutatorComparer
    {
        ...
        {
            PropertyMutator<int> highPriorityMutator = new PropertyMutator<int>(SimpleMutator, "SimplePropertyMutator",
                MutatePriority.High);
            PropertyMutator<int> mediumPriorityMutator = new PropertyMutator<int>(SimpleMutator, "SimplePropertyMutator",
                MutatePriority.Medium);
            PropertyMutator<int> lowPriorityMutator = new PropertyMutator<int>(SimpleMutator, "SimplePropertyMutator",
                MutatePriority.Low);
        ...
        public void PriorityComparison()
        {
            ...
            Assert.AreEqual(0, priorityComparer.Compare(highPriorityMutator, highPriorityMutator));
            Assert.AreEqual(0, priorityComparer.Compare(mediumPriorityMutator, mediumPriorityMutator));
            Assert.AreEqual(0, priorityComparer.Compare(lowPriorityMutator, lowPriorityMutator));
            ...
            Assert.Less(0, priorityComparer.Compare(mediumPriorityMutator, highPriorityMutator));
            Assert.Less(0, priorityComparer.Compare(lowPriorityMutator, mediumPriorityMutator));
            Assert.Less(0, priorityComparer.Compare(lowPriorityMutator, highPriorityMutator));
            ...
            Assert.Greater(0, priorityComparer.Compare(highPriorityMutator, mediumPriorityMutator));
            Assert.Greater(0, priorityComparer.Compare(highPriorityMutator, lowPriorityMutator));

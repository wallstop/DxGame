    ...
    */
    ...
    public class EntityPropertiesComponent : Component
    {
        ...
        */
        ...
        {
            Force moveLeft = new Force(new DxVector2(-EntityProperties.MoveSpeed.CurrentValue, 0));
            new PhysicsAttachment(moveLeft, Parent.Id).Emit();
        }

        protected virtual void EmitMoveRightForce()
        {
            Force moveRight = new Force(new DxVector2(EntityProperties.MoveSpeed.CurrentValue, 0));
        ...
        protected virtual void EmitJumpForce()
        {
            ...
            Force jumpForce = new Force(initialVelocity);

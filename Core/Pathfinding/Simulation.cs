...
namespace DXGame.Core.Pathfinding
{
    public static class Simulation
    {
        ...
        */
        public static DisplacementApproximator RegressForces(CommandChain commandChain, EntityPropertiesComponent properties)
        {
        ...
        private static DisplacementApproximator SimulateAndApproximate(List<Force> initialForces, List<Func<Force>> forceRegenerators)
        {
            ...
            for(double i = 0; i < PathfindingConstants.SimulationUpperBound; i += PathfindingConstants.SimulationStep)
            {
                ...
                gameTime = new DxGameTime(gameTime.TotalGameTime + PathfindingConstants.SimulationTimeStep, PathfindingConstants.SimulationTimeStep, false);

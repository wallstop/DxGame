    ...
    public class PathfindingModel : Model
    {
        ...
        public PathfindingResult Pathfind(GameObject entity, DxVector2 target)
        {
            ...
            */
            ...
            {
                NavigableSurface.Node.EmptyNode
            };
            SortedSet<NavigableSurface.Node> available =
                new SortedSet<NavigableSurface.Node>(Comparer<NavigableSurface.Node>.Create((first, second) =>
                {
                    int distanceCompare =
        ...
        private static PathfindingResult ReconstructPath(ExplorableMesh mesh, NavigableSurface.Node end,
            Dictionary<NavigableSurface.Node, NavigableSurface.Node> traveledFrom)
        {
